<header id="page-topbar">
    <div class="navbar-header">
        <div class="d-flex">
             ...
             <div class="navbar-brand-box">
                <a href="<?php echo e(url('assets/dashboard')); ?>" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="<?php echo e(url("build/images/logo_s.png")); ?>" alt="" height="40">
                    </span>
                    <span class="logo-lg">
                        <img src="<?php echo e(url("build/images/logo.png")); ?>" alt="" height="60">
                    </span>
                </a>

                <a href="<?php echo e(url('assets/dashboard')); ?>" class="logo logo-light">
                    <span class="logo-sm">
                        <img src="<?php echo e(url("build/images/logo_s.png")); ?>" alt="" height="40">
                    </span>
                    <span class="logo-lg">
    ...
    <div class="d-flex">
        <div class="button-items" style="margin-right:30px;margin-top:15px;">
            <a href="<?php echo e(url('assets/vehicle_dashboard')); ?>"><button style="width:150px;" type="button" class="btn btn-success waves-effect btn-label waves-light"><i class="bx bx-check-double label-icon"></i> Dashboard</button></a>
            <button style="width:150px;" type="button" class="btn btn-warning waves-effect btn-label waves-light"><i class="bx bx-error label-icon "></i> Graph</button>
            <button style="width:150px;" type="button" class="btn btn-danger waves-effect btn-label waves-light"><i class="bx bx-block label-icon "></i> Reports</button>
        </div>
        ...
        <div class="dropdown d-inline-block">
            ...
            <div class="dropdown-menu dropdown-menu-end">
               ...
               <a class="dropdown-item" href="contacts-profile"><i class="bx bx-user font-size-16 align-middle me-1"></i> <span key="t-profile"><?php echo app('translator')->get('translation.Profile'); ?></span></a>
                ...
                <a class="dropdown-item d-block" href="#" data-bs-toggle="modal" data-bs-target=".change-password"><i class="bx bx-wrench font-size-16 align-middle me-1"></i> <span key="t-settings"><?php echo app('translator')->get('translation.Settings'); ?></span></a>
...
<?php /**PATH E:\xampp\htdocs\wings\resources\views/layouts/topbar.blade.php ENDPATH**/ ?>