            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    <a href="vehicles" class="has-arrow waves-effect">
                        <i class="bx bx-car"></i>
                        <span key="t-vehicles"><?php echo app('translator')->get('translation.Vehicles'); ?></span>
                    </a>
                </li>
                <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
...
<!-- Left Sidebar End -->
<?php /**PATH E:\xampp\htdocs\gpstrack\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>