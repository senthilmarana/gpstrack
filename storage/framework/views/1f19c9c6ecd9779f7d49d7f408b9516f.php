    ...
    <div data-simplebar class="h-100">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    <a href="<?php echo e(url('admin/users')); ?>" class="waves-effect">
                        <i class="bx bx-user"></i>
                        <span key="t-users">Users</span>
                    </a>
                </li>
                <li>
                    <a href="<?php echo e(url('admin/vehicles')); ?>" class="waves-effect">
                        <i class="bx bx-car"></i>
                ...
                <li>
                <a class="dropdown-item text-danger" href="javascript:void();" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="bx bx-power-off font-size-24 align-middle me-1 text-danger"></i> <span key="t-logout"><?php echo app('translator')->get('translation.Logout'); ?></span></a>
...
<!-- Left Sidebar End -->
<?php /**PATH E:\xampp\htdocs\wings\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>