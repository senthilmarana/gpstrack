<header id="page-topbar">
    <div class="navbar-header">
        <div class="d-flex">
             ...
             <div class="navbar-brand-box">
                <a href="{{url('assets/dashboard') }}" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="{{ url("build/images/logo_s.png") }}" alt="" height="40">
                    </span>
                    <span class="logo-lg">
                        <img src="{{ url("build/images/logo.png") }}" alt="" height="60">
                    </span>
                </a>

                <a href="{{url('assets/dashboard') }}" class="logo logo-light">
                    <span class="logo-sm">
                        <img src="{{ url("build/images/logo_s.png") }}" alt="" height="40">
                    </span>
                    <span class="logo-lg">
    ...
    <div class="d-flex">
        <div class="button-items" style="margin-right:30px;margin-top:15px;">
            <a href="{{url('assets/vehicle_dashboard') }}"><button style="width:150px;" type="button" class="btn btn-success waves-effect btn-label waves-light"><i class="bx bx-check-double label-icon"></i> Dashboard</button></a>
